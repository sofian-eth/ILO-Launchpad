...
contract SSSairdropfactoryTST is Ownable{
    ...
    function feedData(SEprivateairdropTST _airdrop, airdropinfo calldata _airdropinfoo) internal {
    ...
    function createAirdrop(airdropinfo calldata _airdropinfoo) external payable
    {
        ...
        SEprivateairdropTST airdrop = new SEprivateairdropTST(_airdropinfoo.tokenAddress, msg.sender, _airdropinfoo.distributionTimeUnix, _airdropinfoo.quantity, address(this));
